...
public class Downloader implements DownloadURLParams.URLParamsCreator<LiteEntity>, Runnable {
    ...
    public Downloader(LiteContext context, DownloadTask task, DownloadURLParams.URLParamsCreator<LiteEntity> creator) {
    ...
    private class ResumeableContentHandler {
        ...
        public void complete(int cause, int curpos) {
            LiteLog.v("complete cause = %d, length = %d",
                    new Object[] {Integer.valueOf(cause), Integer.valueOf(curpos)});
