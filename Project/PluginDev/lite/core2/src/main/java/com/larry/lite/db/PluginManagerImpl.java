...
import com.larry.lite.download.PluginDownloadTask;
import com.larry.lite.download.PluginDownloader;
import com.larry.lite.download.URLParams;
        ...
        if (this.mRunningTask == null && this.mQueue.size() != 0) {
            if (!NetworkHelper.sharedHelper().isNetworkAvailable()) {
                ...
                if (entity == null) {
                    ...
                    this.downloader = new PluginDownloader(this.mContext, task, (URLParams.URLParamsCreator) null);
