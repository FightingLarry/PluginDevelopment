...
public class PluginDownloader implements URLParams.URLParamsCreator<PluginEntity>, Runnable {
    ...
    private URLParams.URLParamsCreator<PluginEntity> mParamsCreator;
    ...
    public PluginDownloader(PluginContext context, PluginDownloadTask task,
            URLParams.URLParamsCreator<PluginEntity> creator) {
        this.mContext = context;
        this.mClient = context.getConnectionFactory().getOkHttpClient();
        this.mTask = task;
        this.mEntity = task.getEntity();
        this.mParamsCreator = (URLParams.URLParamsCreator) (creator != null ? creator : this);
