...
import com.tcl.dc.PLog.Logger;
import com.tcl.dc.internal.Connections;
import com.tcl.dc.internal.LocalConfigurationCrawler;
import com.tcl.dc.internal.RemoteConfigurationCrawler;
import com.tcl.dc.network.NetworkHelper;
import com.tcl.dc.network.NetworkSensor;
import com.tcl.dc.utils.AndroidUtil;
import com.tcl.dc.utils.PrefsUtils;
import java.io.File;
...
public class PluginService extends Service {
    ...
    public void onCreate() {
        ...
        if (context.isLocalDebug()) {
            context.setConfigurationCrawler(new LocalConfigurationCrawler(context));
        } else {
            context.setConfigurationCrawler(new RemoteConfigurationCrawler(context, context.getConnectionFactory()));
        }
