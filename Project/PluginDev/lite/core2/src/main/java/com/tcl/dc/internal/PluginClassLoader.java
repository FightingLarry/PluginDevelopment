...
public class PluginClassLoader extends ClassLoader {
    ...
    private boolean checkExecuteFile(File dir, String name) {
        ...
        return !(new File(destDir, "classes.dex")).exists() ? true : !(new File(destDir, "manifest.json")).exists();
    }
    ...
    private static PluginClassLoader.Manifest parseManifestFromPath(File file) throws PluginException {
        try {
            String jsonString = GZipUtils.readZipFile(file, "manifest.json");
            PLog.d("parseManifestFromPath : " + jsonString, new Object[0]);
    ...
    public DCPlugin loadPlugin() throws ClassNotFoundException, IllegalAccessException, InstantiationException {
