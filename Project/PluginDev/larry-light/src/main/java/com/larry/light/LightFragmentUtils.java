...
public class LightFragmentUtils {

    private static final String TAG = "LightFragmentUtils";
    ...
    public static void navigateToInNewActivity(Context context, Class<?> fragment, Bundle bundle, View v) {
        Intent intent = new Intent(context, LightArbitraryActivity.class);
        if (bundle != null && bundle.getBoolean(ARGUMENTS_KEY_NO_BACK_STACK)) {
            intent.addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY);
        }
        intent.putExtra(LightArbitraryActivity.EXTRAS_FRAGMENT_CLASS_NAME, fragment.getName());
        ...
        if (v != null && hasJellyBean()) {
            ...
            intent.putExtra(LightArbitraryActivity.EXTRAS_BUNDLE, bundle);
